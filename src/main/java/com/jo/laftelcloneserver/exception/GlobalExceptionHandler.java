package com.jo.laftelcloneserver.exception;

import com.jo.laftelcloneserver.response.ErrorCode;
import com.jo.laftelcloneserver.response.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    protected ResponseEntity<ErrorResponse> handleUsernameNotFoundException(UsernameNotFoundException e) {
        ...
        return new ResponseEntity<>(response, ErrorCode.USERNAME_NOT_FOUND.getStatus());
    }
    /**
     * 유효하지 않은 유저 접근이 있을 때
     */
